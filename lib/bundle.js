...
class Board {
  ...
  findHorizontalMatch(){
    ...
    for(let i = 0; i < this.grid.length; i++){
      for(let j = 0; j < this.grid.length - 1; j++){
        if (this.grid[i][j].color === null) {
          continue;
        } else if (this.grid[i][j].color === this.grid[i][j+1].color){
          matchLength ++;
  ...
  findVerticalMatch(){
    ...
    for(let i = 0; i < this.grid.length; i++){
      for(let j = 0; j < this.grid.length - 1; j++){
        if (this.grid[j][i].color === null) {
          continue;
        } else if (this.grid[j][i].color === this.grid[j+1][i].color){
          matchLength ++;
        } else if (matchLength >= 3){
  ...
  checkSwap(){
    if(this.isValidPos()){
      ...
      if(this.findHorizontalMatch().concat(this.findVerticalMatch()).length > 0){
        console.log(this.findHorizontalMatch().concat(this.findVerticalMatch()))
